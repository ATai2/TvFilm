 ...
 */
package com.tuojin.tvfilm.net.socket;
...
import static com.tuojin.tvfilm.net.socket.WebSocketProtocol.B0_FLAG_FIN;
import static com.tuojin.tvfilm.net.socket.WebSocketProtocol.B0_FLAG_RSV1;
import static com.tuojin.tvfilm.net.socket.WebSocketProtocol.B0_FLAG_RSV2;
import static com.tuojin.tvfilm.net.socket.WebSocketProtocol.B0_FLAG_RSV3;
import static com.tuojin.tvfilm.net.socket.WebSocketProtocol.B0_MASK_OPCODE;
import static com.tuojin.tvfilm.net.socket.WebSocketProtocol.B1_FLAG_MASK;
import static com.tuojin.tvfilm.net.socket.WebSocketProtocol.B1_MASK_LENGTH;
import static com.tuojin.tvfilm.net.socket.WebSocketProtocol.OPCODE_BINARY;
import static com.tuojin.tvfilm.net.socket.WebSocketProtocol.OPCODE_CONTINUATION;
import static com.tuojin.tvfilm.net.socket.WebSocketProtocol.OPCODE_CONTROL_CLOSE;
import static com.tuojin.tvfilm.net.socket.WebSocketProtocol.OPCODE_CONTROL_PING;
import static com.tuojin.tvfilm.net.socket.WebSocketProtocol.OPCODE_CONTROL_PONG;
import static com.tuojin.tvfilm.net.socket.WebSocketProtocol.OPCODE_FLAG_CONTROL;
import static com.tuojin.tvfilm.net.socket.WebSocketProtocol.OPCODE_TEXT;
import static com.tuojin.tvfilm.net.socket.WebSocketProtocol.PAYLOAD_BYTE_MAX;
import static com.tuojin.tvfilm.net.socket.WebSocketProtocol.PAYLOAD_LONG;
import static com.tuojin.tvfilm.net.socket.WebSocketProtocol.PAYLOAD_SHORT;
import static com.tuojin.tvfilm.net.socket.WebSocketProtocol.toggleMask;
import static com.tuojin.tvfilm.net.socket.WebSocketProtocol.validateCloseCode;
