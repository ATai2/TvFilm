 ...
 * 修改备注：
 */
public class RabYearAdapter extends BaseAdapter {

    List<DirectListBean.DataBean.DirectorBean> mList;
    Context mContext;
    CateListFilmPresenterImpl mPresenter;

    public RabYearAdapter(List<DirectListBean.DataBean.DirectorBean> list, Context context, CateListFilmPresenterImpl presenter) {
        mList = list;
        mContext = context;
