...
import com.tuojin.tvfilm.modules.main.sortlist.SortActivity;
...
public class OtherFragment extends BaseFragment<SortListContract.View, SortListPresenterImpl> implements SortListContract.View {
    ...
    public void setFirst() {
        ...
        mGridLayoutManager.getChildAt(1).setOnFocusChangeListener(new View.OnFocusChangeListener() {
            @Override
            public void onFocusChange(View v, boolean hasFocus) {
                if (aBoolean&& SortActivity.rightFirst&&hasFocus){
                    mGridLayoutManager.getChildAt(0).requestFocus();
                    SortActivity.rightFirst=false;
                    aBoolean=false;
                }
            }
        });
