...
public class RabDirectorAdapter extends BaseAdapter {
    ...
    public RabDirectorAdapter(List<DirectorBean> list, Context context, CateListFilmPresenterImpl presenter) {
        mList = list;
        mContext = context;
        mPresenter = presenter;
    }

    public RabDirectorAdapter(List<DirectorBean> list, Context context) {
        mList = list;
        mContext = context;
    }
