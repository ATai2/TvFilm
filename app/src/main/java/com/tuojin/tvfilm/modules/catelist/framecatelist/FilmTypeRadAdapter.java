...
/**
 * 文 件 名: FilmTypeRadAdapter
 * 创 建 人: Administrator
 * 创建日期: 2016/9/28 18:26
 * 文件描述：
 * 邮   箱:
 * 博   客:
 * 修改时间：
 * 修改备注：
 */
public class FilmTypeRadAdapter extends RecyclerView.Adapter<FilmTypeRadAdapter.RadioBtnViewHolder> {
    ...
    public FilmTypeRadAdapter(Context context, List list) {
        mList = list;
        mContext = context;
    }
    ...
    public void onBindViewHolder(RadioBtnViewHolder holder, int position) {
        FilmTypeBean bean = mList.get(position);
