...
//
///**
// * 文 件 名: MyJCVideoPlayerStandard
// * 创 建 人: Administrator
// * 创建日期: 2016/10/20 17:27
// * 文件描述：
// * 邮   箱:
// * 博   客:
// * 修改时间：
// * 修改备注：
// */
//public class MyJCVideoPlayerStandard extends MyJCVideoPlayer {
...
//
//    protected MyJCVideoPlayerStandard.DismissControlViewTimerTask mDismissControlViewTimerTask;
//
//
...
//        cacheImageView = (JCResizeImageView) findViewById(fm.jiecao.jcvideoplayer_lib.R.id.cache);
//
...
//            MyJCVideoPlayerStandard jcVideoPlayer = ((MyJCVideoPlayerStandard) JCVideoPlayerManager.getFirst());
...
//        mDismissControlViewTimerTask = new MyJCVideoPlayerStandard.DismissControlViewTimerTask();
