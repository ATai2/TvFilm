 ...
 * 修改备注：
 */
public class FocusEnlargeViewGroup extends LinearLayout {

    private Animation mScaleToLarge;
    private int mAnimationDuration=100;

    public FocusEnlargeViewGroup(Context context) {
        super(context);
        initAnimation();
    }

    public FocusEnlargeViewGroup(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public FocusEnlargeViewGroup(Context context, AttributeSet attrs, int defStyleAttr) {
