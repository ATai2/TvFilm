package com.tuojin.tvfilm.mp4player;
...
public class EasyVideoPlayer extends FrameLayout implements IUserMethods, TextureView.SurfaceTextureListener,
    ...
    private final Runnable mUpdateCounters = new Runnable() {
        ...
        public void run() {
            ...
            mLabelDuration.setText(Util.getDurationString(dur, true));
...
//        mBtnRight.setText(text);
    ...
    protected void onFinishInflate() {
        ...
        mBtnLeft = (ImageButton) mControlsFrame.findViewById(R.id.btnLeft);
        mBtnLeft.setOnClickListener(this);
//        mBtnLeft.setImageDrawable(mRestartDrawable);
        ...
        mBtnRight = (ImageButton) mControlsFrame.findViewById(R.id.btnRight);
        mBtnRight.setOnClickListener(this);
//        mBtnRight.setText(mSubmitText);
...
//        mBtnRight.setTextColor(labelColor);
