...
import static com.tuojin.appwidget.R.id.viewpager;

public class MainActivity extends AppCompatActivity implements OpenTabHost.OnTabSelectListener {
    ...
    @BindView(R.id.vp_main_lay)
    RelativeLayout mVpMainLay;
